...
async def sincronizar(campaign_id: str, usuario_id: str, rol: str) -> dict:
    """Sincroniza respuestas nuevas desde Gmail."""
    nuevas = await replies_service.sincronizar_respuestas_campana(campaign_id, usuario_id, rol)
...
async def responder(reply_id: str, cuerpo: str, usuario_id: str, rol: str) -> dict:
    ...
    resultado = await replies_service.responder(reply_id, cuerpo, usuario_id, rol)
